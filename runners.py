...
def inference(model, tokenizer, test_dataloader, device, args):
    ...
    with torch.no_grad():
        for batch in tqdm(test_dataloader, desc='Inference...'):
            ...
            if args.model == 'vit' or args.model == 'long_ts' or args.model == 'big_ts' or args.model == 'beit':
                # Afib Accuracy
    ...
    if args.model == 'vit' or args.model == 'big_ts' or args.model == 'long_ts' or args.model == 'beit':
    ...
    elif args.model == 'vit' or args.model == 'big_ts' or args.model == 'beit' or args.model == 'long_ts':
        np_save = {
                'gt_afib' : ground_truth_afib,
                'pred_afib' : pred_afib,
            }
